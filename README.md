...
万花筒不会凭空创造光，而是让同一束光经过不同镜片，形成不断变化的图案。

AI Audience 也不凭空制造热闹。屏幕画面、主播声音和房间对话构成同一个真实现场，
不同 AI 观众则像不同镜片，用各自的性格、立场与记忆理解它。最终出现的不是整齐划一
的答案，而是一组彼此不同、又共同属于当下现场的声音。

**它提供的不是一个 AI 的回答，而是一整个观众席的反应。**
