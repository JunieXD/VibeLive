        ...
        *,
        ...
        for index, candidate in enumerate(result.candidates):
            ...
            event = BarrageEvent(
                ...
                room_id=scope.session_id,
                session_id=scope.session_id,
                audience_epoch=1,
                observation_id=scope.observation_id,
                generation_request_id=scope.request_id,
                viewer_instance_id=safe_audience_id,
                persona_id=safe_audience_id,
                display_name=safe_audience_id,
                viewer_sequence=1,
